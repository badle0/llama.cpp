...
TUNING_PROFILE_GFX1150_QWEN35_Q4KM_V3 = "gfx1150-qwen35-q4km-v3"
...
TUNING_PROFILE_QWEN35_V3_KERNEL_LIST = PROFILE_ROOT / "flagos-amd-tuning-profile-qwen35-v3.inc"
TUNING_PROFILE_KERNEL_LISTS = (
    TUNING_PROFILE_KERNEL_LIST,
    TUNING_PROFILE_QWEN35_KERNEL_LIST,
    TUNING_PROFILE_QWEN35_V3_KERNEL_LIST,
)
...
TUNING_PROFILE_GFX1150_QWEN35_Q4KM_V3_KERNEL_ABIS = read_tuning_profile_kernel_abis(
    TUNING_PROFILE_QWEN35_V3_KERNEL_LIST, "FLAGOS_AMD_TUNED_KERNEL_V3", True)
TUNING_PROFILE_GFX1150_QWEN35_Q4KM_V3_KERNELS = frozenset(
    TUNING_PROFILE_GFX1150_QWEN35_Q4KM_V3_KERNEL_ABIS)
...
TUNING_PROFILES = {
    ...
    TUNING_PROFILE_GFX1150_QWEN35_Q4KM_V3: (
        "gfx1150", TUNING_PROFILE_GFX1150_QWEN35_Q4KM_V3_KERNEL_ABIS),
}
