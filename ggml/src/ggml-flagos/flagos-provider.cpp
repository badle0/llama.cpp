...
bool flagos_device_caps_are_valid(const flagos_device_caps * caps) {
    ...
    switch (caps->kind) {
        ...
        case flagos_provider_kind::dsp:
        case flagos_provider_kind::matrix:
        case flagos_provider_kind::other:
            break;
        default:
            return false;
    }
...
static flagos_engine_kind flagos_engine_from_kind(flagos_provider_kind kind) {
    switch (kind) {
        ...
        case flagos_provider_kind::dsp:
            return flagos_engine_kind::dsp;
        case flagos_provider_kind::matrix:
            return flagos_engine_kind::matrix;
        case flagos_provider_kind::other:
